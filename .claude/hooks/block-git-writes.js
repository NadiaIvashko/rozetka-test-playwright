...
const blockedPatterns = [
  ...
  { re: /\bgit\s+worktree\s+move\b/, label: 'git worktree move' },
  { re: /\bgit\s+worktree\s+lock\b/, label: 'git worktree lock' },
  { re: /\bgit\s+worktree\s+unlock\b/, label: 'git worktree unlock' },
  { re: /\bgit\s+worktree\s+repair\b/, label: 'git worktree repair' },
